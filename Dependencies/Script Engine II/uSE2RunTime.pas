...
type
  ...
  protected
    ...
    function  GetOnAborted: TNotifyEvent;
    procedure SetOnAborted(Value: TNotifyEvent);
  ...
  public
    ...
    property OnAborted         : TNotifyEvent     read GetOnAborted          write SetOnAborted;
  end;
...
function TSE2RunTime.GetOnAborted: TNotifyEvent;
begin
  Result := FContext.OnAborted;
end;
...
procedure TSE2RunTime.SetOnAborted(Value: TNotifyEvent);
begin
  FContext.OnAborted := Value;
end;
